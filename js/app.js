...
}}function limpiar(){global.value='';document.querySelectorAll('.f').forEach(x=>x.value='');render()}global.onkeyup=render;render();<\/script></body></html>`;const w=open("","_blank");if(!w)return mostrarToast("Permita ventanas emergentes para ver el detalle");w.document.write(html);w.document.close();}    
